...
class RheinPfalzKreisSpider(scrapy.Spider):
    name = "rhein_pfalz_kreis"
    path = '//home/johanngrobe/python_env/politik/Websites/Rhein-Pfalz-Kreis'

    # custom_setting = {
    #     'FILES_STORE': 'Dateien/Kreise/Rhein-Pfalz-Kreis'
    ...
    def start_requests(self):
        ...
        for file in os.listdir(self.path):
            ...
            if os.path.splitext(file)[-1] == '.htm':
                    url = f'file:///home/johanngrobe/python_env/politik/Websites/Rhein-Pfalz-Kreis/{file}'
            ...
            if 'Dokumente' in gen_doc_header:
                ...
                for doc, doc_pw in zip(gen_doc, await meeting_attachments.all()):
                    ...
                    if doc.css("svg::attr(data-icon)").get() == 'file-pdf':
                        ...
                        try:
                            await page.wait_for_selector(".page-text-layer span", timeout=30000)
