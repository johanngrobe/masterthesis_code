...
class ViernheimSpider(scrapy.Spider):
    name = 'viernheim'

    custom_settings = {
        'FILES_STORE': 'Dateien/Kommunen/Viernheim'
    }

    path = r'Websites/Viernheim'
    ...
    def parse_sitzungen(self, response):
        ...
        for generel_document in generel_documents:
            ...
            try:
                ...
                file_name = generel_document.xpath("@href").get().split('/')[-1]
                doc_name = generel_document.xpath("@aria-label").get().replace(" im PDF-Format öffnen", "")
    ...
    def parse_status(self, response, file_item):
        ...
        rel_path = 'Dateien/Kommunen/Viernheim/'
