...
class KreisHeilbronnSpider(scrapy.Spider):
    name = 'kreis_heilbronn'
    path = 'Websites/Kreis_Heilbronn'
    base_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

    
    custom_settings = {
        'FILES_STORE': 'Dateien/Kreise/Kreis_Heilbronn'
    }
    ...
    def parse_sitzungen(self, response):
        ...
        kommune = 'Kreis_Heilbronn'

        kommunale_ebene = 'Kreis'

        rel_path = f'Dateien/Kreis/{kommune}/'
    ...
    def parse_status(self, response, file_item):
        ...
        rel_path = 'Dateien/Kreis/Kreis_Heilbronn/'
