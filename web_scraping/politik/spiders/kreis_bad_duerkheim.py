...
class KreisBadDuerkheimSpider(scrapy.Spider):
    name = 'kreis_bad_duerkheim'

    custom_settings = {
        'FILES_STORE': 'Dateien/Kreise/Kreis_Bad_Duerkheim'
    }
    urls = []
  
    for date in range (2004,2023):
        crawl_url = f"http://www.buergerinfo-kreis-duew.de/si0046.php?__cjahr={date}&__cmonat=1&__canz=12&smccont=85&__osidat=d&__kgsgrnr=2&__cselect=65536"
    ...
    def parse(self, response):
        ...
        base_url = 'http://www.buergerinfo-kreis-duew.de/'
    ...
    def parse_sitzungen(self, response):
        ...
        kommune_clean = 'Kreis Bad Dürkheim'
        kommunale_ebene = 'Kreis'

        kommune = 'Kreis_Bad_Duerkheim'
