...
class HasslochSpider(scrapy.Spider):
    name = 'hassloch'

    custom_settings = {
        'FILES_STORE': 'Dateien/Kommunen/Hassloch'
    }

    urls = []
  
    for date in range (2010,2023):
        crawl_url = f"https://sessionnet.krz.de/hassloch/bi/si0046.asp?__cjahr={date}&__cmonat=1&__canz=12&smccont=85&__osidat=d&__kgsgrnr=27&__cselect=65536"
        urls.append(crawl_url)
    
    start_urls = urls

    def parse(self, response):
        base_url = 'https://sessionnet.krz.de/hassloch/bi/'
