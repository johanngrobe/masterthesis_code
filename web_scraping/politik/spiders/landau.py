...
class LandauSpider(scrapy.Spider):
    name = 'landau'

    custom_settings = {
        'FILES_STORE': 'Dateien/Kommunen/Landau'
    }
    
    urls = []
    
    for date in range (2004,2023):
        crawl_url = f"https://info.landau.de/0001_bi/si0046.asp?__cjahr={date}&__cmonat=1&__canz=12&__osidat=d&smccont=85&__kgsgrnr=1&__cselect=65536"
    ...
    def parse(self, response):
        ...
        base_url = 'https://info.landau.de/0001_bi/'
