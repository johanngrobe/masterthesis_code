...
class PirmasensSpider(scrapy.Spider):
    name = 'pirmasens'

    custom_settings = {
        'FILES_STORE': 'Dateien/Kommunen/Pirmasens'
    }

    urls = []
  
    for date in range (2019,2023):
        crawl_url = f"https://rip.stadt-pirmasens.de/bi/si0046.asp?__cjahr={date}&__cmonat=1&__canz=12&smccont=85&__osidat=d&__kgsgrnr=2&__cselect=65536"
    ...
    def parse(self, response):
        base_url = 'https://rip.stadt-pirmasens.de/bi/'
