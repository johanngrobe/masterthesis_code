...
class SchwetzingenSpider(scrapy.Spider):
    name = 'schwetzingen'

    custom_settings = {
        'FILES_STORE': 'Dateien/Kommunen/Schwetzingen'
    }

    urls = []
  
    for date in range (2005,2023):
        crawl_url = f"https://ratsinfo.schwetzingen.de/bi/si0046.php?__cjahr={date}&__cmonat=1&__canz=12&smccont=85&__osidat=d&__kgsgrnr=1&__cselect=65536"
        urls.append(crawl_url)
    
    start_urls = urls

    def parse(self, response):
        base_url = 'https://ratsinfo.schwetzingen.de/bi/'
