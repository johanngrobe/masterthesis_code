...
class WoerthAmRheinSpider(scrapy.Spider):
    name = 'woerth_am_rhein'


    custom_settings = {
        'FILES_STORE': 'Dateien/Kommunen/Wörth_am_Rhein'
    }

    urls = []
  
    for date in range (2009,2023):
        crawl_url = f"https://sessionnet.krz.de/woerth_am_rhein/bi/si0046.asp?__cjahr={date}&__cmonat=1&__canz=12&__osidat=d&smccont=85&__kgsgrnr=1&__cselect=65536"
    ...
    def parse(self, response):
        ...
        base_url = 'https://sessionnet.krz.de/woerth_am_rhein/bi/'
    ...
    def parse_sitzungen(self, response):
        ...
        kommune_clean = 'Wörth am Rhein'

        kommune = 'Wörth_am_Rhein'
        ...
        for row in file_table:
            ...
            if row.xpath("td/div/div/div/div/div/a/@href").get() is not None:
                ...
                top_name = row.xpath("td[@class='tolink']/div/a/text()").get()
